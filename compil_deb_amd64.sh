mkdir ./tmp
mkdir ./tmp/KatyushaMCD_$1-$2_amd64
mkdir ./tmp/KatyushaMCD_$1-$2_amd64/DEBIAN
...
Homepage: http://katyusha-mcd.projet-phosphore.anazaar.org" > ./tmp/KatyushaMCD_$1-$2_amd64/DEBIAN/control

mkdir ./tmp/KatyushaMCD_$1-$2_amd64/usr
...
mkdir ./tmp/KatyushaMCD_$1-$2_amd64/usr/share/Phosphore
mkdir ./tmp/KatyushaMCD_$1-$2_amd64/usr/share/Phosphore/KatyushaMCD

cp ./Katyusha.tcl ./tmp/KatyushaMCD_$1-$2_amd64/usr/share/Phosphore/KatyushaMCD/
cp ./gpl-3.0.txt ./tmp/KatyushaMCD_$1-$2_amd64/usr/share/Phosphore/KatyushaMCD/

mkdir ./tmp/KatyushaMCD_$1-$2_amd64/usr/share/applications
echo "[Desktop Entry]
Type=Application
Name=Katyusha! MCD
...
MimeType=text/x-mcd
Keywords=SQL; Merise;" > ./tmp/KatyushaMCD_$1-$2_amd64/usr/share/applications/KatyushaMCD.desktop

cp -r ./C ./tmp/KatyushaMCD_$1-$2_amd64/usr/share/Phosphore/KatyushaMCD/C
cp -r ./images ./tmp/KatyushaMCD_$1-$2_amd64/usr/share/Phosphore/KatyushaMCD/images
...
dpkg-deb --build --root-owner-group ./tmp/KatyushaMCD_$1-$2_amd64

mv ./tmp/KatyushaMCD_$1-$2_amd64.deb ./OUT
