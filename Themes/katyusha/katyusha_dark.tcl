namespace eval ttk::theme::katyusha_dark {
  ...
  array set colors {
    ...
    ttk::style theme create katyusha_dark -parent default -settings {
        ...
        # Button
        ttk::style element create Frame.frame image [list $images(button)] -border 3 -padding {3 2} -sticky ewns
        ...
        ttk::style element create Notebook.tab \
            ...
            ] -padding {4 4 4 2} -border {5 3 5 0} -sticky ewns
        ...
        ttk::style configure TButton -padding {8 4 8 4} -width -10 -anchor center -relief flat
        ...
        ttk::style configure TNotebook -tabmargins {0 2 0 0} -darkcolor $colors(-darkest) -lightcolor $colors(-darkest) -bordercolor $colors(-darkest)
...
proc ttk::theme::katyusha_dark::color {color} {
    array set colors {
    -disabledfg	  "DarkGrey"
    -nbframe  	  "#2c2c2c"
    -frame  	  "#1c2023"
...
package provide ttk::theme::katyusha_dark $version
